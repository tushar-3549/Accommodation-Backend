...
class PropertyCardSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Property
        fields = [
            "id", "name", "slug", "category", "star_rating", "city",
...
class PropertyDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Property
        fields = [
            "id", "name", "slug", "category", "address", "star_rating",
...
class PropertyCreateSerializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = [
            ...
            "star_rating", "latitude", "longitude", "is_featured"
        ]
...
class RoomTypeCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = RoomType
        fields = ["id", "property", "name", "capacity_adults", "capacity_children"]

class RatePlanCreateSerializer(serializers.ModelSerializer):
    class Meta:
        model = RatePlan
        fields = ["id", "room_type", "name", "refundable", "cancellation_policy"]